...
The folder structure is mandatory for organizing and managing the created output files effectively.
All is described in the folder structure instructions: .github/instructions/folder-structure.instructions.md
‼️ Make sure to follow the folder structure instructions carefully to maintain consistency and organization.
‼️ If an agent needs to know the folder structure, for read/write/update files, always refer to the folder structure instructions: .github/instructions/folder-structure.instructions.md
